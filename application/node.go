...
//}
//
//func NewNode(cfg *god.Config, logger *zap.Logger) (*Node, error) {
//	if cfg.Node.ID < 0 {
//		return nil, god.ErrInvalidNodeID
//	}
//	return &Node{
//		ID:       cfg.Node.ID,
//		Logger:   logger,
...
//	if svc == nil {
//		return god.ErrFailedInitialization
//	}
//
//	_, ok := n.services[svcType]
//	if ok {
//		return god.ErrDuplicateService
//	}
//
